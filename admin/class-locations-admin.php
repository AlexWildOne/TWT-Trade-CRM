...
final class TWT_TCRM_Locations_Admin {
  ...
  public static function boot() {
    ...
    // IMPORTANTE:
    // Não enfileiramos aqui assets do editor do CPT twt_location.
    // Isso deve ser responsabilidade do includes/class-cpt-locations.php,
    // para evitar duplicação (locations.js vs locations-gmaps.js) e conflitos.
  }
  ...
  public static function page_locations() {
    ...
    echo '<p class="twt-tcrm-hint">Dica: este link é o que vais gravar no NFC por loja. O check-in valida geolocalização no front.</p>';
    echo '</div>';
  }
  ...
  public static function page_assignments() {
    ...
    if ($msg === 'assigned') {
      ...
      echo '<div class="notice notice-warning"><p>Falta a tabela de atribuições de lojas na DB. Corre o upgrade/ativação do plugin.</p></div>';
    }
